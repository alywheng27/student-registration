...
export function AuthProvider({ children }) {
  ...
  const updateUser = async (userData) => {
    ...
    try {
      ...
      formData.append('elementary_school_address', userData.elementary_school_address || '');
      formData.append('elementary_year_graduated', userData.elementary_year_graduated || '');
      formData.append('junior_high_school', userData.junior_high_school || '');
      formData.append('junior_high_school_address', userData.junior_high_school_address || '');
      formData.append('junior_high_year_graduated', userData.junior_high_year_graduated || '');
      formData.append('senior_high_school', userData.senior_high_school || '');
      formData.append('senior_high_school_address', userData.senior_high_school_address || '');
      formData.append('senior_high_year_graduated', userData.senior_high_year_graduated || '');
      // Parents
      ...
      formData.append('emergency_relationship', userData.emergency_relationship || '');
  ...
  const updatePassword = async (currentPassword, newPassword) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setLoading(false);
        return { success: false, error: data.error || "Update password failed" };
      }
    } catch (error) {
      setLoading(false);
